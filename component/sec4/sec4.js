...
let listOf = [
    {extraIMG:"img/arash.png", name:"ارش", nikname:"باهری", datauser:"فعال و علاقه‌مند به حوزهٔ تکنولوژی و مدافع نرم افزار آزاد",titleera:"کارگاه", era:"پیاده‌سازی مانیتوریگ با prometheus در محیط‌های شخصی",miniimg:"img/mini-arash.png"},
    {extraIMG:"img/melika.png", name:"ملیکا ", nikname:"قدیری", datauser:"فعال در حوزه تحلیل و طراحی محصول. علاقمند به کاربرپژوهی و بررسی رفتار کاربر در کار با اپلیکیشن‌ها",titleera:"تحلیل ui/ux اوبنتو", era:"تحلیل رابط کاربری اوبنتو 24.04",miniimg:"img/mini-mlika.png"},
    {extraIMG:"img/farooq.png", name:"فاروق", nikname:"کریمی زاده", datauser:"برنامه‌نویس، پژوهش‌گر برنامه‌نویسی ژنتیک، گیمر و بازی‌ساز ماین‌تست، مشارکت‌کنندهٔ ویکی‌پدیای فارسی و انگلیسی",titleera:"کامپیوتر های تک برد", era:" رزبری پای، نانو پای، لیبره کامپیوتر، ESP32 و ارونج‌پای",miniimg:"img/mini-r4.png"},
    {extraIMG:"img/mmd.png", name:"محمد ", nikname:"مزارعی", datauser:"توسعه‌دهندهٔ سفت‌افزار، طراح و توسعه دهنده سیستم‌های نهفته(embedded( با و بدون سیستم عامل، علاقه‌مند به حوزهٔ رادیو‌آماتوری و هم‌بنیان‌گذار وب‌سایت سیسوگ (مرجع متن باز آموزش الکترونیک) ",titleera:"بررسی و شبیه سازی حمله gps spoofing ", era:"بررسی روش های حمله gps spoofing و شبیه سازی حمله با استفاده از ابزارهای متن باز ",miniimg:"img/mini-r3.png"},
    ...
    {extraIMG:"img/ex-jadi.png", name:"جادی", nikname:"هکر خندون:)", datauser:"امیرعماد میرمیرانی (زادهٔ ۲۵ دی ۱۳۵۶) که با نام مستعار جادی شناخته می‌شود، برنامه‌نویس، هکر، گیک، فعال حوزهٔ تکنولوژی‌های جدید، جامعهٔ نرم‌افزار آزاد و وبلاگ‌نویس اهل ایران است. او مجری پادکستی با عنوان «رادیو گیک» است که بعداً نامش به «رادیو جادی» تغییر یافت",titleera:"از این اوبونتو تا اون اوبونتو", era:"آپدیت جدید اوبونتو و تغییرات آن",miniimg:"img/mini-r1.png"},
]
...
<link rel="stylesheet" href="css/slid.css">
  ...
  <div class="container flex flex-col h-full justify-around" >
    ...
    <div class="indicators flex  gap-5  justify-center p-7">
        ...
        <div id="btn-cont" class="flex justify-center md:gap-5 w-2/12 md:w-full">
