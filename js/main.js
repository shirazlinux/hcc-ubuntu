...
$.querySelector("#sec6").insertAdjacentHTML("beforeend",`   <div class="flex p-7   flex-col text-white text-center">
        <a href="#sec7" class="font-light  text-2xl ">
        <p>حامیان و اسپانسر ها  </p> 
        <i class="fa-solid fa-chevron-down"></i>
        </a>
    </div>`)
$.querySelector("#sec7").insertAdjacentHTML("beforeend",`   <div class="flex p-7   flex-col text-white text-center">
        <a href="#sec9" class="font-light  text-2xl ">
        <p>ثبت نام </p> 
        <i class="fa-solid fa-chevron-down"></i>
        </a>
